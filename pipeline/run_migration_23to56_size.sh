...
MODEL_FOLDER="sequencies/migration_23to56_mig_02_constant_size_rec_${RECOMB_RATE}_seq_${SEQ_LENGTH}"
...
python3 ../msprime_scripts/msprime_migration_23to56.py \
    ...
    -name "migration_23to56_constant_size_rec_${RECOMB_RATE}_seq_${SEQ_LENGTH}" \
    -how_many 100 \
    -rec $RECOMB_RATE \
    -mig_ratio 0.2 \
